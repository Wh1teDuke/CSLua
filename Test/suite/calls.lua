...
-- CSLUA_FAIL cannotload("unexpected symbol", load(read1("*a = 123")))
cannotload("unexpected symbol", load("*a = 123"))
-- CSLUA_FAIL cannotload("hhi", load(function () error("hhi") end))
...
-- CSLUA_FAIL a = assert(load(read1(x)))
-- CSLUA_FAIL assert(a()(2)(3)(10) == 15)
