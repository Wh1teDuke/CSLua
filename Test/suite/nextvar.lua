...
-- CSLUA_FAIL assert(type(ipairs{}) == 'function' and ipairs{} == ipairs{})
...
-- CSLUA_FAIL  assert(not pcall(table.insert, a, 2, 20));
  table.insert(a, 10); table.insert(a, 2, 20);
  table.insert(a, 1, -1); table.insert(a, 40);
  table.insert(a, #a+1, 50)
  table.insert(a, 2, -2)
-- CSLUA_FAIL  assert(not pcall(table.insert, a, 0, 20));
-- CSLUA_FAIL  assert(not pcall(table.insert, a, #a + 2, 20));
...
a = {[0] = "ban"}
-- CSLUA_FAIL  assert(#a == 0 and table.remove(a) == "ban" and a[0] == nil)
...
-- CSLUA_FAIL  assert(not pcall(table.remove, a, 0))
assert(a[#a] == 40)
