...
public class LuaCSharp
{
    ...
    private const string CodeNBody = """
                                     sun = {}
                                     jupiter = {}
                                     saturn = {}
                                     uranus = {}
    ...
    private readonly LuaValue[] _buffer = new LuaValue[1];
    ...
    public async Task<LuaValue> BenchmarkAdd_LuaCSharp()
    {
        await _luaCs.DoStringAsync(CodeAdd, _buffer);
        return _buffer[0];
    }
    
    [Benchmark(Description = "CSLua")]
    [BenchmarkCategory("Add")]
    ...
    [Benchmark(Description = "Lua-CSharp")]
    [BenchmarkCategory("NBody")]
    public async Task<LuaValue> BenchmarkNBody_LuaCSharp()
    {
        await _luaCs.DoStringAsync(CodeNBody, _buffer);
        return _buffer[0];
    }
    
    [Benchmark(Description = "CSLua")]
    [BenchmarkCategory("NBody")]
    public double BenchmarkNBody_CSLua()
    {
        _csLua.DoString(CodeNBody);
        return 0;
    }
}